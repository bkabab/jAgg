...
public class RecordGeometricMean {
   private String trialClass;
   private double testResult;
   public RecordGeometricMean(String trialClass, double result) 
      {
...
public static StringBuffer someMethod()
{
	List<RecordCount> rawData = new ArrayList<RecordCount>();
	 ...
	 // count of elements
	  aggregators.add(new GeometricMeanAggregator("testResult"));
 ...
 {
	 RecordGeometricMean.someMethod().toString();
 }
}