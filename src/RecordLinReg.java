...
public class RecordLinReg {
   private String trialClass;
   private double testResult;
   public RecordLinReg(String trialClass, double result) 
      {
...
public static StringBuffer someMethod()
{
	...
	// properties.add("trialClass");
	 ...
	 // Covar
	 aggregators.add(new LinearRegressionAggregator("testResult","testResult"));
 ...
 {
	 RecordLinReg.someMethod().toString();
 }
}