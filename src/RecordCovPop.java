...
public class RecordCovPop {
   private String trialClass;
   private double testResult;
   public RecordCovPop(String trialClass, double result) 
      {
...
public static StringBuffer someMethod()
{
	...
	// properties.add("trialClass");
	 ...
	 // Covar
	 aggregators.add(new CovariancePopAggregator("testResult","testResult"));
 ...
 {
	 RecordCovPop.someMethod().toString();
 }
}